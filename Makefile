...
SpaceArcade-Linux-Debug:
	 $(PROJECTBUILD) SpaceArcade Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceArcade-Linux-DebugGame:
	 $(PROJECTBUILD) SpaceArcade Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceArcade-Linux-Shipping:
	 $(PROJECTBUILD) SpaceArcade Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceArcade-Linux-Test:
	 $(PROJECTBUILD) SpaceArcade Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceArcade:
	 $(PROJECTBUILD) SpaceArcade Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceArcadeEditor-Linux-Debug:
	 $(PROJECTBUILD) SpaceArcadeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceArcadeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SpaceArcadeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceArcadeEditor-Linux-Shipping:
	 $(PROJECTBUILD) SpaceArcadeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceArcadeEditor-Linux-Test:
	 $(PROJECTBUILD) SpaceArcadeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SpaceArcadeEditor:
	 $(PROJECTBUILD) SpaceArcadeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
